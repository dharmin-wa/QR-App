        ...
        ? qrCodess?.map((qr: any, index: number) => (
          ...
          >
            <Grid
              ...
              md={12}
              lg={12}
              sx={{ display: "flex", flexDirection: "row", justifyContent: { sm: 'center', xs: 'center', lg: "" } }}
            >
              {/* first section */}
              <Grid
                sm={12}
                md={12}
                lg={5}
                sx={{ display: "flex", justifyContent: { md: "center", sm: "center", lg: "start" } }}
              >
                <QRStack
                  direction={"row"}
